...
<html lang="en">
  <head>
    ...
    <title>PERPANJANG | PELAYANAN SIM ONLINE</title>
...
<div class="container">
  <main>
    ...
    <form  action="/perpanjang" method="post">
      @csrf
      <div class="form-group">
          ...
          <div class="form-group">
            <label for="inputNosim">No SIM Lama</label>
            <input type="text" class="form-control" name="sim_lama" id="inputNosim" placeholder="Masukan No SIM Lama">
          </div>
          <p></p>
          <a href="/dashboard">
